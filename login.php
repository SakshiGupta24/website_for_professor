...
<?php
	...
	$s="select * from signup where username='$user1' and password='$psw1'";	
...
<nav class="navbar navbar-expand-sm bg-info navbar-dark fixed-top justify-content-center">
  ...
  </a><a class="nav-item nav-link active" href="mainpage1.php">Home</a>
...
<h3 align="center"><p>Login as Administrator</p></h3>
	<form action="login.php" method="post">
	 <input type="text" name="username" placeholder="Username" required>
        <input type="password" name="password" placeholder="Password" required>
        <input type="submit" value="Login" name="s3"></form>
		</div>
</body>
</html>