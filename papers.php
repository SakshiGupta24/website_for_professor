...
<title>Enter Research Papers</title>
<style>
...
<br><br><br>
      ...
      <?php
           if(!empty($_POST['s1']))
		   {
			   ...
			   $abo=$_POST['about'];
			   $yea=$_POST['year'];
			   $s="insert into papers(paper,about,year)values('$pap','$abo','$yea')";
...
<h3 align="center"><p>Enter Research Papers</p></h3>
<br>
	<form action="papers.php" method="post" enctype="multipart/form-data">
	<input type="text" placeholder="Enter Research paper ID" name="paper" required>
	<input type="text" placeholder="Enter details" name="about" required>
